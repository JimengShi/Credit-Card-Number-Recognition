...
threshCnts = threshCnts[1] if imutils.is_cv3() else threshCnts[0]      # check opencv version
...
for (i, (gX, gY, gW, gH)) in enumerate(locs):
	...
	digitCnts = digitCnts[1] if imutils.is_cv3() else digitCnts[0]  # check opencv version
	digitCnts = contours. sort_contours(digitCnts, method="left-to-right")[0]

	# threshCnts = cv2.findContours(thresh.copy(), cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)
	# threshCnts = refCnts[1] if imutils.is_cv3() else refCnts[0]  # check opencv version
